...
public interface IEmailSender
{
    ...
    Task<bool> SendBookingStartEmail(DateOnly startDay, TimeOnly startTime, string ownerId, string sitterId, CancellationToken cancellationToken = default);
    
    Task<bool> SendBookingCompleteEmail(DateOnly startDay, TimeOnly startTime, string ownerId, string sitterId, CancellationToken cancellationToken = default);
