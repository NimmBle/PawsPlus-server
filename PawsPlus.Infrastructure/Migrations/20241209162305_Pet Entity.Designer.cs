...
namespace PawsPlus.Infrastructure.Data.Migrations
{
    ...
    [Migration("20241209162305_Pet Entity")]
    partial class PetEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PawsPlus.Domain.Models.JobPost", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("PawsPlus.Domain.Models.Pet", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Age", "PawsPlus.Domain.Models.Pet.Age#Age", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("HealthStatus", "PawsPlus.Domain.Models.Pet.HealthStatus#HealthStatus", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Personality", "PawsPlus.Domain.Models.Pet.Personality#Personality", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("PawsPlus.Domain.Models.JobPost", b =>
                {
                    b.HasOne("PawsPlus.Domain.Models.Profile", "Profile")
                        .WithOne("JobPost")
                        .HasForeignKey("PawsPlus.Domain.Models.JobPost", "ProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
